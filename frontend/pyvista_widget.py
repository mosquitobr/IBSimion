...
class PyVistaWidget(QWidget):
    ...
    def set_theme_mode(self, theme_mode):
        """Sets the background and grid colors based on dark/light mode."""
        ...
        self.plotter.show_grid(color=grid_color)
        
        # Update cube axes colors if they exist
        ...
        # Update scalar bars text colors
        ...
        for idx, traj in enumerate(self.trajectories):
            ...
            if color_by == 'species':
                ...
                scalar_bar_args = {
                    'title_font_size': 12,
                    'label_font_size': 10,
                    'color': 'black' if getattr(self, 'theme_mode', 'dark') == 'light' else 'white',  # Dynamic!
